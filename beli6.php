...
<body>
    <div class="container">
        ...
        <img src="images/r.png" alt="Sepeda untuk Dijual"> <!-- Ganti dengan path gambar sepeda yang sesuai -->
        <p>Di sini Anda dapat melanjutkan untuk membeli sepeda yang Anda inginkan.</p>
        <h2>Detail Sepeda</h2>
        <p class="price">Harga: <span style="color: #f7c17b">Rp</span> <span style="color: #325662">2.500.000</span></p>
